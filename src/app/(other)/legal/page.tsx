                    ...
                    <div className="flex flex-col space-y-6">
                        <div className="flex flex-col">
                            ...
                            <ul role="list" className="mt-1 text-sm list-disc marker:text-primary-500 space-y-1">
                                <li className="ml-4">Visit our website at <Link className="text-primary-500 hover:underline" href={'https://www.copy-pasta.ch/'}>www.copy-pasta.ch</Link>, or any website of ours that links to this Privacy Notice</li>
                            ...
                            <p className="mt-2 text-sm text-zinc-800 dark:text-zinc-200">Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <Link className="text-primary-500 hover:underline" href={'mailto:info@copy-pasta.ch'}>info@copy-pasta.ch</Link>.</p>
                        </div>
                    </div>
                </div>
                <div></div>
