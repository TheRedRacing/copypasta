        ...
        <div className="w-full flex-1 flex flex-col py-24 -space-y-px">
            ...
            <div className="grid grid-cols-12 grid-rows-1 border border-zinc-300 dark:border-zinc-800">
                ...
                <div className="col-start-2 col-end-12 row-start-1 row-end-1 border-x border-zinc-300 dark:border-zinc-800 py-10">
                    <h2 className="text-5xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100 text-center">Contact me</h2>
                </div>
                <div className=""></div>
            </div>
            <div className="grid grid-cols-12 grid-rows-1 border border-zinc-300 dark:border-zinc-800">
                ...
                <div className="col-start-2 col-end-12 row-start-1 row-end-1 border-x border-zinc-300 dark:border-zinc-800 flex items-center justify-center">
                    <p className="text-zinc-600 dark:text-zinc-400">You can contact me for any questions, feedback, or support.</p>
                </div>
                <div className="aspect-square"></div>
            </div>
                    ...
                    <div className="p-10 space-y-12">
                        <div className="flex gap-x-6">
                            ...
                            <div>
                                ...
                                <p className="text-base/7 text-zinc-600 dark:text-zinc-400">If you have any questions or feedback, feel free to reach out to me directly via email or LinkedIn.</p>
                        ...
                        <div className="flex gap-x-6">
                            ...
                            <div>
                                ...
                                <p className="text-base/7 text-zinc-600 dark:text-zinc-400">You can report any bugs or issues you encounter while using the site by opening an issue on GitHub.</p>
                                <div className="mt-2 flex flex-col text-sm/6 font-semibold">
